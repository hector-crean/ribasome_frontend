...
impl UICommand {
    ...
    pub fn text_and_tooltip(self) -> (&'static str, &'static str) {
        match self {
            #[cfg(not(target_arch = "wasm32"))]
            UICommand::Save => ("Save…", "Save all data to a data file "),

            #[cfg(not(target_arch = "wasm32"))]
            UICommand::SaveSelection => (
                "Save loop selection…",
                "Save data for the current loop selection to a data file ",
            ),

            #[cfg(not(target_arch = "wasm32"))]
            UICommand::Open => ("Open…", "Open a Data File "),

            #[cfg(not(target_arch = "wasm32"))]
            UICommand::Quit => ("Quit", "Close the Viewer"),
            ...
            UICommand::ToggleMemoryPanel => (
                "Toggle Memory Panel",
                "View and track current RAM usage inside Viewer",
            ),
